...
void Field::delCandidates(int val, int x, int y, Cells mas[9][9]) {			//исключение кандидатов по вертикали, горизонтали и в малом квадрате
	for (int k = 0; k < 9; k++) {
...
bool Field::arrangement(Cells tmpField[9][9]) {
	bool flag;
	bool flag2 = true;
	do {
		flag = true;
